...
categories: [accounting, accounting-standards]
...
India’s financial reporting landscape is poised for a major overhaul, marking the most significant transformation since the initial transition to Ind AS. The Institute of Chartered Accountants of India (ICAI) has released the **Exposure Draft of Ind AS 118, *Presentation and Disclosure in Financial Statements***.

This new standard replaces the longstanding Ind AS 1 and represents a comprehensive overhaul of how performance is presented and communicated. Financial reporting professionals should be well-informed about this upcoming shift.
...
Don’t worry, you have ample time to prepare.

* **Effective Date:** The proposed effective date in India is for annual reporting periods commencing on or after **April 1, 2027**.
* **Comparative Information:** When the standard takes effect you’ll need to restate your figures for the previous year (2026-27) to align with the new format.
...
## Conclusion  
Ind AS 118 represents a significant step towards enhancing the clarity and comparability of financial statements in India. While it introduces new challenges for companies, it ultimately benefits investors and analysts by providing a more standardized and transparent view of financial performance. Early preparation and understanding of the new requirements will be crucial for a smooth transition when the standard takes effect in 2027.
